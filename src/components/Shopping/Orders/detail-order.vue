<template>
  <v-card class="elevation-12">
    <v-toolbar dark color="#6ab414">
      <v-toolbar-title >Pre compra</v-toolbar-title>
      <v-spacer></v-spacer>
      <v-icon medium @click="closeModal()">mdi-close-box</v-icon>
    </v-toolbar>
    <v-card-text>
        <v-form>
                        ...
                        <v-flex xs12 md12>
                            <v-layout justify-center row wrap>
                                <v-flex>
                                    ...
                                    <v-checkbox v-model="info[0].lunes"></v-checkbox>
                                </v-flex>
                                <v-flex>
                                    <label class="title">M</label>
                                    <v-checkbox v-model="info[0].martes"></v-checkbox>
                                </v-flex>
                                <v-flex>
                                    <label class="title">X</label>
                                    <v-checkbox v-model="info[0].miercoles"></v-checkbox>
                                </v-flex>
                                <v-flex>
                                    <label class="title">J</label>
                                    <v-checkbox v-model="info[0].jueves"></v-checkbox>
                                </v-flex>
                                <v-flex>
                                    <label class="title">V</label>
                                    <v-checkbox v-model="info[0].viernes"></v-checkbox>
                                </v-flex>
                                <v-flex>
                                    <label class="title">S</label>
                                    <v-checkbox v-model="info[0].sabado"></v-checkbox>
                                </v-flex>
                                <v-flex>
                                    <label class="title">D</label>
                                    <v-checkbox v-model="info[0].domingo"></v-checkbox>
                                </v-flex>
                            </v-layout>
                        </v-flex>
                    </v-layout>
    ...
    <v-card-actions>
      <v-spacer></v-spacer>
      <v-btn dark color="#6ab414" style="width:100%" @click="processPreOrder()">Guardar</v-btn>
    </v-card-actions>
  </v-card>
</template>
<style>
