<template>
  ...
  <!--v-if="access"-->
      ...
      <v-navigation-drawer
        ...
        <v-list dense>
            ...
            <v-list-tile @click="dirigir('/preOrderList')">
                ...
                <v-list-tile-content>
                <v-list-tile-title>Pre ordenes</v-list-tile-title>
                </v-list-tile-content>
            </v-list-tile>
            ...
            <v-list-tile @click="dirigir('/categoryList')">
                ...
                <v-list-tile-content>
                <v-list-tile-title>Transacciones y pagos</v-list-tile-title>
                </v-list-tile-content>
            </v-list-tile>
            ...
            <v-list-tile @click="dirigir('/categoryList')">
                ...
                <v-list-tile-content>
                <v-list-tile-title>Logística de producción</v-list-tile-title>
                </v-list-tile-content>
            </v-list-tile>
    ...
    <v-footer color="indigo" app>
      <span class="white--text">&copy; v0.0.39</span>
    </v-footer>
  </v-app>
</template>
<style>
